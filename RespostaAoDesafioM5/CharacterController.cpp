...
// Defina as linhas da sua spritesheet para cada direção
#define ANIM_SOUTH 0 // Linha 0 (a de baixo) -> Andar para baixo
#define ANIM_EAST  1 // Linha 1 -> Andar para a direita
#define ANIM_WEST  2 // Linha 2 -> Andar para a esquerda
#define ANIM_NORTH 3 // Linha 3 (a de cima) -> Andar para cima
